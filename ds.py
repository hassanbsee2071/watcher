...
def restart_deployment(v1_apps, deployment_name, namespace):
    ...
    for deployment in deployment_name:
        try:
            ...
            v1_apps.patch_namespaced_daemon_set(deployment, namespace, body, pretty='true')
...
namespace="devops"
deployment_name=["kubecost-network-costs"]


deployments = deployment.list_namespaced_daemon_set(namespace=namespace)
print(deployments)
